 ...
 * generated in the com.jroc.trainingprocessor.model.trainingcenterdatabase package.
...
public class ObjectFactory {
  ...
  private final static QName _TrainingCenterDatabase_QNAME = new QName(
      "http://www.garmin.com/xmlschemas/TrainingCenterDatabase/v2", "TrainingCenterDatabase");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: com.jroc.trainingprocessor.model.trainingcenterdatabase
   */
   ...
   * @return the new instance of {@link JAXBElement }{@code <}{@link TrainingCenterDatabaseT }{@code
   * >}
   */
  @XmlElementDecl(namespace = "http://www.garmin.com/xmlschemas/TrainingCenterDatabase/v2", name = "TrainingCenterDatabase")
  public JAXBElement<TrainingCenterDatabaseT> createTrainingCenterDatabase(
      TrainingCenterDatabaseT value) {
    return new JAXBElement<TrainingCenterDatabaseT>(_TrainingCenterDatabase_QNAME,
        TrainingCenterDatabaseT.class, null, value);
  }
