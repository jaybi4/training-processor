...
/**
 * Identifies the originating GPS device that tracked a run or used to identify the type of device
 * capable of handling the data for loading.
 *
...
public class DeviceT
   ...
   *
   * @return possible object is {@link VersionT }
   */
   ...
   *
   * @param value allowed object is {@link VersionT }
   */
